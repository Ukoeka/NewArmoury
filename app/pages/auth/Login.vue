  ...
  <div class="min-h-screen bg-[#0A0E1A] flex">
    ...
    >
      ...
      <NuxtLink to="/" class="flex items-center gap-2.5 group w-fit">
        ...
        <span
          class="text-[15px] font-bold tracking-tight text-slate-100 group-hover:text-white transition-colors"
        >
          {{ appName }}
        </span>
      </NuxtLink>
      ...
      <div class="flex flex-1 items-center justify-center">
        <div class="w-full max-w-sm">
          ...
          <div class="mb-8">
            <h1
              class="text-[26px] font-bold text-slate-100 tracking-tight mb-1.5"
            >
    ...
    <div
      class="hidden lg:flex flex-1 relative overflow-hidden bg-[#070b14] border-l border-[#1e2535]"
    >
      <!-- Ambient glow -->
      <div
      ...
      <div class="relative z-10 flex flex-col justify-between w-full p-14">
        ...
        <div>
          ...
          <h2
            class="text-[30px] font-black text-slate-100 tracking-tight leading-snug max-w-sm"
          >
            Centralised Firearm<br />
            <span class="text-blue-500">Management</span> for<br />
            Your Organisation
          </h2>
          <p class="mt-4 text-[14px] text-slate-500 leading-relaxed max-w-xs">
        ...
        <div class="flex flex-col gap-3 my-8">
          <div
            class="flex items-center gap-4 bg-[#161b27] border border-[#1e2535] rounded-xl px-5 py-4"
          >
            <div
            ...
            <div>
              <div class="text-[13px] font-semibold text-slate-200">
                OTP-Gated Issuance
              </div>
        ...
        <div>
          <p
            class="text-[11px] text-slate-600 uppercase tracking-wider font-semibold mb-2.5"
          >
            Access roles
          </p>
...
function roleBadgeClass(role: string) {
  ...
  return map[role] ?? "bg-slate-800/60 text-slate-300 border-slate-700/50";
}
</script>
