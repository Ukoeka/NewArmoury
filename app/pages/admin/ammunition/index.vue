  ...
  <div class="p-6 min-h-screen bg-[#0A0E1A] text-slate-200 font-sans">
    ...
    <div class="flex items-start justify-between mb-6">
      ...
      <div class="flex gap-2.5">
        <button class="flex items-center gap-1.5 bg-transparent text-slate-400 border border-slate-700 rounded-lg px-4 py-2 text-sm font-semibold cursor-pointer hover:border-blue-500 hover:text-slate-200 transition-all">
          <Settings2 :size="14" />
          Register Type
        </button>
        <button class="flex items-center gap-1.5 bg-blue-600 text-white border-none rounded-lg px-4 py-2 text-sm font-semibold cursor-pointer hover:bg-blue-700 transition-colors">
          <Plus :size="14" />
          Add Inventory
        </button>
      </div>
    ...
    <div class="inline-flex bg-[#161b27] border border-[#1e2535] rounded-[10px] p-1 gap-1 mb-6">
      <button
        ...
        class="px-8 py-2 bg-transparent border-none rounded-[7px] text-slate-500 text-[13.5px] font-medium cursor-pointer transition-all"
        :class="activeTab === tab.id ? 'bg-[#1e2535] !text-slate-100 font-semibold' : 'hover:text-slate-400'"
      >
        {{ tab.label }}
      </button>
    </div>
      ...
      <div class="bg-[#161b27] border border-[#1e2535] rounded-xl overflow-hidden">
        ...
        >
          ...
          <div class="flex justify-end flex-[1] pl-4">
            <button class="flex items-center gap-1.5 text-slate-500 text-[13px] font-medium cursor-pointer px-3 py-1.5 rounded-lg border border-transparent hover:bg-[#1e2535] hover:text-slate-300 hover:border-slate-700/60 transition-all whitespace-nowrap">
              <Plus :size="13" />
              Adjust
            </button>
          </div>
