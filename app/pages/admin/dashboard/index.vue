<template>
  ...
  >
    <!-- Page Header -->
    <div>
      <h1 class="text-2xl font-bold text-slate-100 -tracking-[0.3px] mb-1">
        Dashboard
      </h1>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
      ...
      >
        <div class="flex flex-col gap-1.5">
          <span class="text-[14px] text-slate-500 font-medium"
            >Total Firearms</span
          >
          <span class="text-[28px] text-blue-500 font-bold leading-none"
            >10</span
          >
          <span class="text-[12px] text-slate-500"
            >Good: 9 · Malfunction: 1</span
          >
        </div>
        <ShieldCheck :size="32" class="text-blue-500 shrink-0" />
      </div>
      <div
        class="bg-[#1a0d0d] border border-red-900/35 rounded-xl px-7 py-7 flex items-center justify-between"
      >
        <div class="flex flex-col gap-1.5">
          <span class="text-[14px] text-slate-500 font-medium"
            >Malfunctioning Arms</span
          >
          <span class="text-[28px] font-bold text-red-500 leading-none">1</span>
          <NuxtLink
            to="/admin/arms-register"
            class="text-[12px] font-semibold text-red-500 no-underline hover:text-red-400"
      ...
      <div
        class="bg-[#130d1f] border border-purple-900/35 rounded-xl px-7 py-7 flex items-center justify-between"
      >
        <div class="flex flex-col gap-1.5">
          <span class="text-[14px] text-slate-500 font-medium"
            >Active Deployments</span
          >
          <span class="text-[28px] font-bold text-purple-400 leading-none"
            >3</span
          >
          <span class="text-[12px] text-slate-500">Personnel on duty</span>
        </div>
        <MapPin :size="32" class="text-purple-400 shrink-0" />
      </div>
      <div
        class="bg-[#1a0e08] border border-orange-900/35 rounded-xl px-7 py-7 flex items-center justify-between"
      >
        <div class="flex flex-col gap-1.5">
          <span class="text-[14px] text-slate-500 font-medium"
            >Ammo Variance Alerts</span
          >
          <span class="text-[28px] font-bold text-orange-500 leading-none"
            >2</span
          >
          <span class="text-[12px] text-slate-500">Items in transit</span>
        </div>
        <Package :size="32" class="text-orange-500 shrink-0" />
      </div>
    </div>
    ...
    <div class="bg-[#161b27] border border-amber-500/20 rounded-xl px-5 py-7">
      <div class="flex items-center gap-2 mb-3.5">
        ...
        <span class="text-[14px] font-semibold text-slate-100"
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        >
          <Package :size="18" class="text-orange-500 shrink-0 mt-0.5" />
          <div>
            <div class="flex items-center gap-2 mb-1">
              <span class="text-[13.5px] font-bold text-slate-100"
                >Low Ammunition Stock</span
              >
              <span
                class="text-[10px] font-bold px-1.5 py-0.5 rounded bg-amber-950/70 text-amber-400 border border-amber-700/50 tracking-wide"
                >WARNING</span
              >
            </div>
            <span class="text-[13px] text-slate-400"
              >7 ammunition type(s) below minimum threshold</span
            >
          </div>
        </div>
        <div
          class="flex items-start gap-3 bg-[#1a0d0d] border border-red-500/25 rounded-[10px] px-4 py-3.5"
        >
          <Wrench :size="18" class="text-red-500 shrink-0 mt-0.5" />
          <div>
            <div class="flex items-center gap-2 mb-1">
              <span class="text-[13.5px] font-bold text-slate-100"
                >Maintenance Overdue</span
              >
              <span
                class="text-[10px] font-bold px-1.5 py-0.5 rounded bg-red-950/70 text-red-400 border border-red-700/50 tracking-wide"
                >CRITICAL</span
              >
            </div>
            <span class="text-[13px] text-slate-400"
              >10 firearm(s) require immediate maintenance</span
            >
          </div>
        </div>
      </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
      ...
      >
        <div class="flex items-center gap-2 px-5 py-4">
          ...
          <span class="text-[14px] font-semibold text-slate-100"
            >Branch Locations & Risk Map</span
          >
        </div>
        <div class="p-3 flex flex-col gap-2.5">
          <div
            ...
            :key="branch.name"
            class="bg-[#1D293D] border border-[#1e2535] rounded-[10px] px-4 py-5"
          >
            <div class="flex items-start justify-between mb-3">
              <div class="flex items-start gap-2.5">
                <span
                  class="w-2.5 h-2.5 rounded-full bg-emerald-500 mt-1 shrink-0"
                  style="box-shadow: 0 0 6px #22c55e66"
                ></span>
                <div>
                  <div class="text-[13.5px] font-bold text-slate-100">
                    {{ branch.name }}
                  </div>
                  <div class="text-[11px] text-slate-500">Branch</div>
                </div>
              </div>
              <span class="text-[14px] font-medium whitespace-nowrap"
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-2">
              ...
              >
                ...
                >
                <span
                  class="text-[18px] font-bold text-blue-400 leading-none"
                  >{{ branch.total }}</span
                >
              </div>
              <div
              ...
              >
                ...
                >
                <span
                  class="text-[18px] font-bold text-emerald-400 leading-none"
                  >{{ branch.available }}</span
                >
              </div>
              <div
                class="bg-[#0F172B] border border-[#1e2535] rounded-lg px-2.5 py-2 flex flex-col items-center gap-1"
              >
                ...
                >
                <span
                  class="text-[18px] font-bold text-purple-400 leading-none"
                  >{{ branch.onDuty }}</span
                >
              </div>
              <div
              ...
              >
                <span class="text-[10.5px] text-slate-500 font-medium"
                  >Issues</span
                >
                <span class="text-[18px] font-bold leading-none text-red-400">{{
                  branch.issues
                }}</span>
              </div>
            </div>
      ...
      >
        <div class="flex items-center gap-2 px-5 py-4">
          ...
          <span class="text-[14px] font-semibold text-slate-100"
            >Out-of-Office Deployments</span
          >
        </div>
        <div class="p-3 flex flex-col gap-3">
          <div
            v-for="dep in outOfOffice"
            :key="dep.name"
            class="flex items-center justify-between bg-[#1D293D] border border-[#1e2535] rounded-lg px-4 py-3"
          >
            <div class="flex items-center gap-2.5">
              <span class="w-2 h-2 rounded-full bg-emerald-500 shrink-0"></span>
              <div>
                <div class="text-[13.5px] font-semibold text-slate-100">
                  {{ dep.name }}
                </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        >
          <div class="flex items-center gap-2 px-6 py-6">
            <TrendingUp :size="20" />
            <span class="text-[14px] font-semibold text-slate-100"
              >Daily Activity Trends (Last 7 Days)</span
            >
          </div>
        ...
        >
          <div class="flex items-center gap-2 px-6 py-6">
            <Activity :size="20" />
            <span class="text-[14px] font-semibold text-slate-100"
              >Ammunition Usage Trend (4 Weeks)</span
            >
          </div>
          <div class="px-5 pt-4 pb-3">
            <apexchart
    ...
    <div class="grid grid-cols-2 gap-4">
      ...
      >
        <div
          class="text-[14px] font-semibold text-slate-100 px-5 py-4 border-b border-[#1e2535]"
        >
        ...
        <div class="px-5 py-4 flex items-center justify-center gap-8">
          <ClientOnly>
            ...
            <template #fallback>
              <div
                class="w-62.5 h-62.5 rounded-full bg-[#1a2030] animate-pulse"
              />
            </template>
          </ClientOnly>
          <div class="flex flex-col gap-3">
            <div class="flex items-center gap-2">
              ...
              <span class="text-[13px] font-semibold text-emerald-400"
                >Good: 9 (90%)</span
              >
            </div>
            <div class="flex items-center gap-2">
              <span class="w-3 h-3 rounded-full bg-red-500 shrink-0"></span>
              <span class="text-[13px] font-semibold text-red-400"
                >Malfunction: 1 (10%)</span
              >
            </div>
          </div>
        </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
      ...
      >
        ...
        <Bell :size="30" class="text-red-500 shrink-0" />
      </div>
      <div
        class="bg-[#1a0e08] border border-orange-900/35 rounded-xl px-5 py-4 flex items-center justify-between"
      >
        <div class="flex flex-col gap-1.5">
          <span class="text-[12px] text-slate-500 font-medium"
            >Low Ammo Stock</span
          ...
          <a
            href="#"
            class="text-[12px] font-semibold text-orange-500 no-underline hover:text-orange-400"
            >Check Stock →</a
          >
        </div>
        <Package :size="30" class="text-orange-500 shrink-0" />
      </div>
      <div
        class="bg-[#0f1829] border border-blue-900/35 rounded-xl px-5 py-4 flex items-center justify-between"
      >
        <div class="flex flex-col gap-1.5">
          <span class="text-[12px] text-slate-500 font-medium"
            >Today's Handovers</span
          >
          <span class="text-[28px] font-bold text-blue-400 leading-none"
            >0</span
          >
          <span class="text-[11.5px] text-slate-500">Issued today</span>
        </div>
        <ShieldCheck :size="30" class="text-blue-400 shrink-0" />
      </div>
      <div
        class="bg-[#0a1208] border border-emerald-900/35 rounded-xl px-5 py-4 flex items-center justify-between"
      >
        <div class="flex flex-col gap-1.5">
          <span class="text-[12px] text-slate-500 font-medium"
            >Branch Availability</span
          >
          <span class="text-[28px] font-bold text-emerald-400 leading-none"
            >9</span
          >
          <span class="text-[11.5px] text-slate-500">Arms available</span>
        </div>
        <Users :size="30" class="text-emerald-400 shrink-0" />
      </div>
    </div>

    <!-- Branch Firearms Availability -->
    <div class="bg-[#161b27] border border-[#1e2535] rounded-xl px-5 py-4">
      <h3 class="text-[14px] font-semibold text-slate-100 mb-4 m-0">
        Branch Firearms Availability
      </h3>
          ...
          <div class="flex items-center gap-3 flex-1 justify-end">
            <div class="w-48 h-1.5 bg-[#1e2535] rounded-full overflow-hidden">
              <div
                ...
                :style="{
                  width: ba.pct + '%',
                  background: ba.pct === 0 ? '#2d3748' : '#22c55e',
                }"
              ></div>
            </div>
            <span
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
      ...
      >
        <div class="flex flex-col gap-1.5">
          ...
          <a
            href="#"
            class="text-[12px] font-semibold text-blue-400 no-underline hover:text-blue-300"
            >Process Now →</a
          >
        </div>
        <Clock :size="45" class="text-blue-400 shrink-0" />
      </div>
      <div
        class="bg-[#1a0e08] border border-orange-900/35 rounded-xl px-5 py-6 flex items-center justify-between"
      >
        <div class="flex flex-col gap-1.5">
          <span class="text-[12px] text-slate-500 font-medium"
            >Returns Due Today</span
          >
          <span class="text-[28px] font-bold text-orange-500 leading-none"
            >0</span
          >
        ...
        <TrendingUp :size="45" class="text-orange-500 shrink-0" />
      </div>
      <div
        class="bg-[#1a0d0d] border border-red-900/35 rounded-xl px-5 py-6 flex items-center justify-between"
      >
        <div class="flex flex-col gap-1.5">
          <span class="text-[12px] text-slate-500 font-medium"
            >Maintenance Due</span
          >
          <span class="text-[28px] font-bold text-red-500 leading-none"
            >10</span
          >
          <a
            href="#"
        ...
        <Wrench :size="45" class="text-red-500 shrink-0" />
      </div>
      <div
        class="bg-[#0a1208] border border-emerald-900/35 rounded-xl px-5 py-6 flex items-center justify-between"
      >
        <div class="flex flex-col gap-1.5">
        ...
        <ShieldCheck :size="45" class="text-emerald-400 shrink-0" />
      </div>
    </div>
    ...
    <div class="bg-[#161b27] border border-[#1e2535] rounded-xl px-5 py-4">
      <div class="flex items-center gap-2 mb-4">
        ...
        <h3 class="text-[14px] font-semibold text-slate-100 m-0">
          Action Items
        </h3>
      </div>
      <div class="flex flex-col gap-2">
        <div
          ...
          :key="item.title"
          class="flex items-center justify-between bg-[#1a0d0d] border border-red-900/25 rounded-lg px-4 py-3.5"
        >
          <div class="flex items-center gap-3">
            <div
              class="w-8 h-8 bg-red-900/20 rounded-lg flex items-center justify-center shrink-0"
            >
          ...
          <NuxtLink
            to="/admin/arms-register"
            class="bg-[#161b27] border border-[#1e2535] rounded border-none text-slate-400 text-[13px] font-semibold cursor-pointer hover:text-slate-200 transition-colors px-2.5 py-1.5"
            >Check</NuxtLink
          >
        </div>
      </div>
...
const actionItems = [
  {
    ...
    desc: "10 firearm(s) need maintenance",
    icon: Wrench,
  },
];
