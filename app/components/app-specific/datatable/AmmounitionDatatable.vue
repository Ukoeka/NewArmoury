...
const columns: ColumnDef<Ammunition>[] = [
  {
    id: "drag",
    header: () => null,
  ...
  },
  {
    ...
    header: "Lot Number", 
    cell: ({ row }) => h("div", String(row.original.lotNumber)),
    enableHiding: false,
  },
  {
    accessorKey: "caliber",
   ...
   {
    accessorKey: "roundsPerBox",
    header: "Rounds Per Box",
    cell: ({ row }) => h("div", String(row.original.roundsPerBox)),
    enableHiding: true,
  },
  {
    accessorKey: "boxes",
    header: "Boxes",
    cell: ({ row }) => h("div", String(row.original.boxes)),
    enableHiding: true,
  },
   {
    accessorKey: "totalRounds",
    header: "Total Rounds",
    cell: ({ row }) => h("div", String(row.original.totalRounds)),
    enableHiding: false,
  },
  {
