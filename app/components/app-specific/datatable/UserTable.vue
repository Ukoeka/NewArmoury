...
const columns: ColumnDef<User>[] = [
  ...
  },
  {
    ...
    header: "First Name",
    cell: ({ row }) => h("div", String(row.original.firstName)),
    enableHiding: false,
  },
  {
    accessorKey: "lastName",
    header: "Last Name",
    cell: ({ row }) => h("div", String(row.original.lastName)),
    enableHiding: false,
  },
  {
    accessorKey: "username",
    header: "Username",
    cell: ({ row }) => h("div", String(row.original.username)),
    enableHiding: true,
  },
  {
    accessorKey: "email",
    header: "Email",
    cell: ({ row }) => h("div", String(row.original.email)),
    enableHiding: true,
  },
  ...
  },
  {
    ...
    header: "Last Login",
    cell: ({ row }) => h("div", String(row.original.lastLogin)),
    enableHiding: false,
  },
