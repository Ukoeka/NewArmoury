...
const props = defineProps<{
  ...
  onConfirmReceipt: (request: Request) => void
}>()
...
const columns: ColumnDef<Request>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => h("div", row.original.assetType),
    enableHiding: true,
  },
  {
    accessorKey: "assetName",
    header: "Asset Name",
    cell: ({ row }) => h("div", row.original.assetName),
    enableHiding: true,
  },
  {
    accessorKey: "quantity",
    header: "Quantity",
    cell: ({ row }) => h("div", row.original.quantity),
    enableHiding: true,
  },
  
  {
    ...
    header: "Request Date",
    cell: ({ row }) => h("div", row.original.requestDate),
    enableHiding: false,
  }, 
  {
    accessorKey: "status",
    ...
    cell: ({ row }) => {
      ...
      return h(Badge, { variant: "outline"}, () => row.original.status.toUpperCase())
    }
  },
      ...
      default: () => [
        ...
        h(DropdownMenuContent, { align: "end" }, {
          default: () => [
            ...
            h(DropdownMenuItem, { onClick: () => props.onConfirmReceipt(row.original), class: 'text-blue-600' }, () => "Confirm Receipt"),
